...
pub use source_config::{
    FileSourceParams, KafkaSourceParams, KinesisSourceParams, PulsarSourceParams, RegionOrEndpoint,
    SourceConfig, SourceParams, VecSourceParams, VoidSourceParams, CLI_INGEST_SOURCE_ID,
