...
impl TryFrom<DefaultDocMapperBuilder> for DefaultDocMapper {
    ...
    fn try_from(builder: DefaultDocMapperBuilder) -> anyhow::Result<DefaultDocMapper> {
        ...
        let default_search_field_names =
            resolve_default_search_fields(&builder.default_search_fields, &schema)?;
...
fn resolve_default_search_fields(
    ...
    'outer: for field_name in default_search_fields {
        ...
        'inner: {
            ...
            let Some(field) = schema.get_field(potential_json_field_name) else {
                break 'inner;
            };
...
mod tests {
    ...
    #[test]
    fn test_doc_mapper_default_search_field_json_field_attribute() {
        let doc_mapper = r#"{
